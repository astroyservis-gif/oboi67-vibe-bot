...
export default function Calculator() {
  ...
  useEffect(() => {
    ...
    setTotal(baseTotal);
  }, [area, primer, dismantle, complexPattern, paper]);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center p-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                  <div className="flex-1">
                    <span className="block font-medium text-gray-900">Бумажные обои</span>
                    <span className="block text-xs text-gray-500 mt-0.5">Поклейка бумажных обоев шириной 0,5 метра</span>
                  </div>
                  <input
                    type="checkbox"
                    checked={paper}
