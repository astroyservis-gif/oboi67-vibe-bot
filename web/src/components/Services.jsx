      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Берем на себя все заботы: от правильного подбора клея до идеальной подгонки рисунка. Работаем чисто, с лазерной точностью. Вы просто заходите в обновленную комнату и наслаждаетесь.
          </p>
        </div>
